...
-- Favelas Global
LocalPlayer["state"]:set("Favela1",false,false)
LocalPlayer["state"]:set("Favela2",false,false)
LocalPlayer["state"]:set("Favela3",false,false)
LocalPlayer["state"]:set("Favela4",false,false)
LocalPlayer["state"]:set("Favela5",false,false)
...
LocalPlayer["state"]:set("Lake",false,true)
LocalPlayer["state"]:set("Route68",false,false)
LocalPlayer["state"]:set("Beacon",false,false)
...
LocalPlayer["state"]:set("Scuba",false,false)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Walk = nil
