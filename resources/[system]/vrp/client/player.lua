...
AddEventHandler("vRP:Active",function(Passport,Name)
	...
	SetDiscordAppId(1166510322606162022)
	SetDiscordRichPresenceAsset("humble")
	SetDiscordRichPresenceAssetSmall("humble")
	SetRichPresence(Passport.." - "..Name)
	SetDiscordRichPresenceAssetText("Humble")
	SetDiscordRichPresenceAssetSmallText("Humble")
...
function ReloadCharacter(Pid,Ped)
	...
	ReplaceHudColourWithRgba(255,0,85,226,255)
