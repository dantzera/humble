...
-- DESTRAVAR
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('destravar')
AddEventHandler('destravar',function()
    local ped = PlayerPedId()
    vSERVER._stopAnim(false)
...
-- LIMPAREA
-----------------------------------------------------------------------------------------------------------------------------------------
function Humble.Limparea(Coords)
